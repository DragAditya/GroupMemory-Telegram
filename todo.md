...
- [ ] Activate the managed retention cleanup schedule after the production site is published.
...
- [ ] Deliver a checkpoint and exact Telegram webhook setup instructions.
